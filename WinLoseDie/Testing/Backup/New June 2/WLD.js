...
// HTML element variable listings....
...
function loadButtons(){
	...
	stopButton.setAttribute("onclick","stopRoll();");
...
function loadDice(){
	...
	sClick.innerHTML = "STOP!";
	sClick.setAttribute("onclick", "stopRoll();");
	butDisable(sClick);
	butEnable(rClick);
...
function rollDice(rdt){
	...
	if(getAnother(valDice)){
		...
		butDisable(rClick);
		keepRest();
		sClick.innerHTML = "Clear";
		sClick.setAttribute("onclick", "loadDice();");
	}
