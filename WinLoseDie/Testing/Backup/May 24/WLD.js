...
function reroll(){
	document.getElementById("funcs").innerHTML = "Function Variables</br>";
	// track roll count
	rolCount -= 1;
...
function scoreCalc(){
	...
	document.getElementById("scoring" + p).insertAdjacentHTML('beforeend','<br/>' + 
		count + '.  Score: ' + sCount + ' Roll Counter: ' + rCount);
...
function unique(){
	...
	// 1s and 5s have values even if not in groups of 3 4 or 5 
...
/* 	document.getElementById("funcs").insertAdjacentHTML("beforeend","loop i: " + i + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","loop j: " + j + "</br>");	 */
	document.getElementById("funcs").insertAdjacentHTML("beforeend","result: " + result + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","s1: " + s1 + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","s5: " + s5 + "</br>");	
	document.getElementById("funcs").insertAdjacentHTML("beforeend","side1: " + side1 + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","side5: " + side5 + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","count: " + count + "</br>");
	document.getElementById("funcs").insertAdjacentHTML("beforeend","roundScore: " + roundScore + "</br>");				
	...
	for (var j = rolCount; j > -1;j--){
		...
		for (var i = 0; i < diceNum;i++){
			...
			// Show variables for troubleshooting...
			// Template document.getElementById("funcs").insertAdjacentHTML("beforeend","xxxx" + xxx);
			document.getElementById("funcs").insertAdjacentHTML("beforeend","During the loop...</br>");
			document.getElementById("funcs").insertAdjacentHTML("beforeend","loop i: " + i + "</br>");
			document.getElementById("funcs").insertAdjacentHTML("beforeend","loop j: " + j + "</br>");				
			document.getElementById("funcs").insertAdjacentHTML("beforeend","result: " + result + "</br>");
			document.getElementById("funcs").insertAdjacentHTML("beforeend","s1: " + s1 + "</br>");
